...
which_key.mappings["q"] = nil
which_key.mappings.q = {
	name = "Quit LunarVim",
	q = { "<cmd>lua require('lvim.utils.functions').smart_quit()<CR>", "Quit LunarVim" },
}

-- normal_mode["<Space>f"] = "<cmd>Telescope find_files<cr>"
-- normal_mode["<Space>b"] = "<cmd>Telescope buffers<cr>"
-- normal_mode["<Space>g"] = "<cmd>Telescope live_grep<cr>"

-- vv not mine vv --

which_key.mappings["a"] = { "<cmd>ccl<cr>", "Close Quickfix" }
which_key.mappings[";"] = { "<cmd>copen<cr>", "Open Quickfix" }
-- which_key.mappings["f"] = { "<cmd>Telescope find_files<cr>", "Find text" }
